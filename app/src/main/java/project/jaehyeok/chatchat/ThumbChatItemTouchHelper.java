...
//        int swipeFlags = ItemTouchHelper.START /*| ItemTouchHelper.END*/; // 왼쪽으로만 스와이프 되도록
...
//        Paint p = new Paint();
//
//        RectF leftButton = new RectF(itemView.getRight() - buttonWidthWithoutPadding, itemView.getTop() + 22, itemView.getRight() - 44 - 60, itemView.getBottom() - 22);
...
//    }
    ...
    private RecyclerChatRoomAdapter mAdapter;

    public ThumbChatItemTouchHelper(RecyclerChatRoomAdapter mAdapter) {
        this.mAdapter = mAdapter;
    }

    public ThumbChatItemTouchHelper(ThumbChatItemAction buttonsActions) {
